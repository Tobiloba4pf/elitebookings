                  ...
                  >
                    ...
                    <div className="lg:w-1/2 p-10 md:p-16 flex flex-col justify-center">
                      ...
                      <div className="flex flex-wrap gap-4">
                        <a 
                          href={`https://wa.me/234702253857?text=${encodeURIComponent(`Hello, I would like to book a stay at ${hotel.name}.\n\nLocation: ${hotel.location}\nPrice: ₦${hotel.price}`)}`}
                          target="_blank"
                ...
                {phShortlets.map((shortlet, idx) => (
                  ...
                  >
                    ...
                    <div className="lg:w-1/2 p-10 md:p-16 flex flex-col justify-center">
                      ...
                      <div className="flex flex-wrap gap-4">
                        <a 
                          href={`https://wa.me/234702253857?text=${encodeURIComponent(`Hello, I would like to book a shortlet stay at ${shortlet.name}.\n\nLocation: ${shortlet.location}\nPrice: ₦${shortlet.price}`)}`}
                          target="_blank"
                          rel="noopener noreferrer"
                          className="bg-charcoal text-cream px-10 py-4 rounded-full text-[11px] uppercase tracking-[0.3em] font-bold hover:bg-gold transition-colors shadow-lg shadow-charcoal/10 inline-block"
                        >
                ...
                {phCars.map((car, idx) => (
                  ...
                  >
                    ...
                    <div className="lg:w-1/2 p-10 md:p-16 flex flex-col justify-center">
                      ...
                      <div className="flex flex-wrap gap-4">
                        <a 
                          href={`https://wa.me/234702253857?text=${encodeURIComponent(`Hello, I would like to rent a ${car.name}.\n\nLocation: ${car.location}${car.price ? `\nPrice: ₦${car.price}` : ''}`)}`}
                          target="_blank"
                          rel="noopener noreferrer"
                          className="bg-charcoal text-cream px-10 py-4 rounded-full text-[11px] uppercase tracking-[0.3em] font-bold hover:bg-gold transition-colors shadow-lg shadow-charcoal/10 inline-block"
                        >
      ...
      <footer className="p-12 border-t border-charcoal/10 flex flex-col md:flex-row justify-between items-center space-y-6 md:space-y-0">
        ...
        <div className="flex items-center space-x-12 text-[12px] uppercase tracking-[0.3em] text-charcoal/80 font-bold">
          <div className="flex items-center space-x-6">
            ...
            <a href="https://wa.me/234702253857" target="_blank" rel="noopener noreferrer" className="hover:text-gold transition-colors transform hover:scale-110" title="WhatsApp">
